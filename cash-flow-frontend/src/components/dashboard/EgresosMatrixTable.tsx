...
export default function EgresosMatrixTable({ currentMonth = '2026-04', projectId = 'patio-sur-oe1035', isReadOnly = false }: Props) {
    ...
    <div className="space-y-4">
      ...
      {detailModalCell && (
        <CellDetailModal
          ...
          projectId={projectId}
          categorias={categorias} // <--- Pasamos las categorias para poder reasignar
