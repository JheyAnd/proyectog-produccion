...
export default function SCurveChart({ 
  ...
  console.log('SCurveChart Debug:', { propsCortes, internalCortes, cortes, typeOfCortes: Array.isArray(cortes) ? 'array' : typeof cortes });
      ...
      <ResponsiveContainer width="100%" height={420}>
        <ComposedChart data={mergedData} margin={{ top: 10, right: 30, left: 10, bottom: 10 }}>
          ...
          <XAxis
            dataKey="week"
            tickFormatter={(val) => {
              const point = mergedData.find(d => d.week === val);
