...
const EntregablesUploadView: React.FC<EntregablesUploadViewProps> = ({
  ...
  const [form, setForm] = useState({
    ...
    venta_suministro: initialValues?.venta_suministro || 0,
    ...
    costo_suministro: initialValues?.costo_suministro || 0,
  ...
  const handleSave = async () => {
    const requiredKeys = [
      'venta_monto_manual', 'venta_suministro', 'venta_administracion', 'venta_mano_obra',
      'costo_monto_manual', 'costo_suministro', 'costo_administracion', 'costo_mano_obra'
    ];
    const emptyFields = requiredKeys.filter(k => !form[k as keyof typeof form]);
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-5">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="text-[12px] font-semibold text-gray-700 uppercase tracking-wide block mb-1.5">Suministro</label>
                    <input 
                      type="number" 
                      value={form.venta_suministro || ''} 
                      onChange={e => setForm({...form, venta_suministro: Number(e.target.value)})}
                      className="w-full bg-gray-50 border border-gray-300 rounded-lg px-3.5 py-2.5 text-[15px] text-gray-900 focus:bg-white focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-colors placeholder-gray-400"
                    />
                  </div>
                  <div>
              ...
              <div className="space-y-5 md:border-l md:border-gray-200 md:pl-8">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input 
                      type="number" 
                      value={form.costo_suministro || ''} 
                      onChange={e => setForm({...form, costo_suministro: Number(e.target.value)})}
                      className="w-full bg-gray-50 border border-gray-300 rounded-lg px-3.5 py-2.5 text-[15px] text-gray-900 focus:bg-white focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-colors placeholder-gray-400"
                    />
                  </div>
                  <div>
