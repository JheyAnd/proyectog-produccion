...
class BusinessCaseModel(Base):
    ...
    venta_materiales: Mapped[Optional[float]] = mapped_column(Numeric(18, 2), nullable=True)
    venta_servicios: Mapped[Optional[float]] = mapped_column(Numeric(18, 2), nullable=True)
    ...
    costo_materiales: Mapped[Optional[float]] = mapped_column(Numeric(18, 2), nullable=True)
    costo_servicios: Mapped[Optional[float]] = mapped_column(Numeric(18, 2), nullable=True)
