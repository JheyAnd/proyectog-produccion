...
export default function ContractSummary({ projectId }: ContractSummaryProps) {
  ...
  // Cálculo del Margen Estimado
  const margenPct = (project.utilidad_proyectada || 0) * 100;
  const margenValor = (project.valor_original_contrato || 0) * (project.utilidad_proyectada || 0);
